...
ob = CubeCobra::OverviewBuilder.new(
  ...
  decks: [
    ...
    CubeCobra::Deck.new(title: 'Izzet Control', mana: 'ur', stars: 3, cards: ['Remand', 'Young Pyromancer', 'Electrolyze']),
    ...
    CubeCobra::Deck.new(title: 'Naya Ramp', mana: 'rgw', stars: 1, cards: ['Palace Jailer', 'Inferno Titan', 'Birds of Paradise']),
    ...
    CubeCobra::Deck.new(title: '5 Color Domain', mana: 'wubrg', stars: 3, cards: ['Territorial Kavu', 'Voice of Resurgence', 'Prismatic Vista']),
