...
ob = CubeCobra::OverviewBuilder.new(
  ...
  decks: [
    ...
    CubeCobra::Deck.new(title: 'Gruul Midrange', mana: 'rg', stars: 4, cards: ['Pyrogoyf', "Esika's Chariot", 'Minsc & Boo, Timeless Heroes']),
    ...
    CubeCobra::Deck.new(title: 'Izzet Aggro Control', mana: 'ur', stars: 3, cards: ['Remand', 'Kari Zev, Skyship Raider', 'Slick Sequence']),
    ...
    CubeCobra::Deck.new(title: 'Simic Ramp', mana: 'gu', stars: 5, cards: ['Mana Drain', 'Nissa, Who Shakes the World', "Uro, Titan of Nature's Wrath"]),
    ...
    CubeCobra::Deck.new(title: 'Temur Midrange', mana: 'gur', stars: 4, cards: ['Sakura-Tribe Elder', 'Bloodbraid Elf', 'Oko, Thief of Crowns']),
